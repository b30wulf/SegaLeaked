...
class NodebuffFFAScoreboard extends Scoreboard
{
  ...
  $damager = "0";
            ...
            return [
              "§f",
              "",
              "§cArena§f: " . TextFormat::WHITE . "Nodebuff",
             ...
             // "§cTheir Ping§f: " . $damager,
              "",
              "§cKillStreak§f: " . KillStreak::getInstance()->getProvider()->getPlayerKSPoints($player),
